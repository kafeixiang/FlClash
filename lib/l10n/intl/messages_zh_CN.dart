...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m44(count) => "${count} 个代理";

  static String m45(count) => "${count} 条规则";

  static String m46(appName) => "${appName}（安全模式）";

  static String m47(count) => "${count} 秒";

  static String m48(count) => "已选择 ${count} 项";

  static String m49(time) => "检测于 ${time}";

  static String m50(label) => "${label}只能是一项";
