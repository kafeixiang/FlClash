...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m44(count) => "プロキシ ${count} 件";

  static String m45(count) => "ルール ${count} 件";

  static String m46(appName) => "${appName}（セーフモード）";

  static String m47(count) => "${count} 秒";

  static String m48(count) => "${count} 件選択中";

  static String m49(time) => "${time} に検査";

  static String m50(label) => "${label}は1項目のみ指定できます";
