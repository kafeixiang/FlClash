...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m44(count) => "${count} прокси";

  static String m45(count) =>
      "${Intl.plural(count, one: '${count} правило', few: '${count} правила', many: '${count} правил', other: '${count} правила')}";

  static String m46(appName) => "${appName} (Безопасный режим)";

  static String m47(count) =>
      "${Intl.plural(count, one: '${count} секунда', few: '${count} секунды', many: '${count} секунд', other: '${count} секунды')}";

  static String m48(count) => "Выбрано: ${count}";

  static String m49(time) => "Проверено в ${time}";

  static String m50(label) => "«${label}» — только одно значение";
