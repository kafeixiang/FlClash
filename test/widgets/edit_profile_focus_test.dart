...
BorderSide _fabRingSide(WidgetTester tester) {
...
void main() {
  ...
  testWidgets('Save FAB shows a visible focus ring while focused', (
    tester,
  ) async {
    await pumpEditProfile(tester);

    BorderSide ringSide() => _fabRingSide(tester);
    ...
    expect(
      ringSide().width,
      2.5,
      reason: 'a visible ring should mark the focused Save FAB',
    );
