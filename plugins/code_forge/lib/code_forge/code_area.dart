...
class CodeForge extends StatefulWidget {
  ...
  /// The editor places the popup below or above the caret line, and keeps
  /// the arrow keys, Enter, Tab and Escape. The popup is laid out no wider
  /// than 400 and no taller than the space on the side it opens on, so it
  /// should size to its content and scroll within those constraints.
  final Widget Function(
    BuildContext context,
