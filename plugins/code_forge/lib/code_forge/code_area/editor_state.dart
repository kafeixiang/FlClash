...
class _CodeForgeState extends State<CodeForge>
  ...
  final ValueNotifier<Offset> _offsetNotifier = ValueNotifier(
    const Offset(0, 0),
  );
  ...
  void initState() {
    ...
    _focusNode.addListener(_openImeConnection);
                  ...
                  return ValueListenableBuilder(
                    ...
                    builder: (_, sugg, child) {
                      ...
                      final left = offset.dx
                          .clamp(0.0, max(0.0, screenWidth - suggestionWidth))
                          .toDouble();
                      final fontSize = widget.textStyle?.fontSize ?? 14;
                      return ValueListenableBuilder(
                        valueListenable: _controller.selectedSuggestionNotifier,
